...
func TestPaymentRefundNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Payments.Refunds.New(
		context.TODO(),
		"id",
		gotue.PaymentRefundNewParams{
			Amount: gotue.Int(500100),
			...
			Receipt: gotue.String("Receipt No. 31"),
			Speed:   gotue.PaymentRefundNewParamsSpeedOptimum,
		},
	)
	if err != nil {
