...
// interacting with the gotue API. You should not instantiate this client directly,
...
// GOTUE_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("GOTUE_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("GOTUE_USERNAME"); ok {
		defaults = append(defaults, option.WithUsername(o))
	}
	if o, ok := os.LookupEnv("GOTUE_PASSWORD"); ok {
...
// environment (GOTUE_USERNAME, GOTUE_PASSWORD, GOTUE_BASE_URL). The option passed
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.PaymentLinks = NewPaymentLinkService(opts...)
